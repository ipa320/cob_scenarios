...
class SMeHealth2012b(smach.StateMachine):
    def __init__(self):
        ...
        with self:
            ...
            smach.StateMachine.add('MOVE_TO_PREGRASP_POSITION', approach_pose([1,0,3.14],mode="omni"),   
                        transitions={'succeeded':'MOVE_TO_GRASP_POSITION', 
                                                'failed':'ended'})
                                   
            smach.StateMachine.add('MOVE_TO_GRASP_POSITION', approach_pose([1.5,0,3.14],mode="linear"),
